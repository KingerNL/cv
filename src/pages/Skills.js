    ...
    return(
        <div className="skills_container">
            ...
            <div className="skills_text">
                ...
                <p>Hoewel ik Mechanical Engineer ben, weet ik ook best veel af van andere onderwerpen.</p>
                ...
                <ul>
                    ...
                    <li><p>TIA Portal / ladder logic</p></li>    
            ...
            <div className="skills-details">
                <div className="chart_box">
                    ...
                    <div className="chart"> 
                        <span>TIA portal / PLC programmeren</span>
                        <footer>
